...
class main_frm(Frame):
    ...
    def make_widget(self):
        ...
        self.icon_img_list = {
            ...
            "record"    : ImageTk.PhotoImage(Image.open(".\\image\\movie_icon2.png").resize(icon_size)),
            "recording" : ImageTk.PhotoImage(Image.open(".\\image\\movie_icon1.png").resize(icon_size)),
            "replay"    : ImageTk.PhotoImage(Image.open(".\\image\\play_icon2.png").resize(icon_size)),
            "replaying" : ImageTk.PhotoImage(Image.open(".\\image\\stop_icon1.png").resize(icon_size)),
        }
    ...
    def active_replay(self, replay_input):
        self.process, self.shared_states = start_replay(*replay_input)
